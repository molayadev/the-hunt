// Firestore document shapes shared between the Cloud Functions (Admin SDK,
// full read/write), the admin app (creates/edits these documents), and the
// player app (reads a subset through firestore.rules). A breaking change
// here is a breaking change across all three.
...
// admins/{uid} — existence of the doc grants admin-app access; see
// firestore.rules and admin/README.md for the bootstrap process.
export interface AdminDoc {
  readonly email: string;
  readonly addedAt: unknown; // Firestore server timestamp
}
